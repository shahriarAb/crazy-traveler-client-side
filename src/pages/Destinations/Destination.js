                ...
                <div>
                    ...
                    <div className="relative px-4 -mt-16  ">
                        <div className="bg-white px-6 pt-4 pb-2 rounded-lg shadow-lg">
                            ...
                            <div>
                                <small className="text-gray-600">{description.slice(0, 125)}...</small>
                            </div>
                            <button onClick={handleDetails} className="bg-gradient-to-r from-red-400 to-red-600 hover:from-red-600 hover:to-red-400 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-opacity-50 py-1 px-8 rounded-lg text-white shadow-md my-2">Book Now</button>
                        </div>
                    </div>
